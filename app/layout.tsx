...
export const metadata: Metadata = {
    title: {
        default: "Workflow Automation for Manual Operations | INVARITECH",
        template: "%s | INVARITECH",
    },
    description:
        "Ops automation for manual workflows: approvals, evidence, reporting bridges, reconciliations, and regulated operations around the systems teams already use.",
    keywords: [
        "INVARITECH",
        "workflow automation",
        "ops automation",
    ...
    openGraph: {
        ...
        title: "Workflow Automation for Manual Operations | INVARITECH",
        description:
            "Ops automation for manual workflows: approvals, evidence, reporting bridges, reconciliations, and regulated operations around the systems teams already use.",
        siteName: "INVARITECH",
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Workflow Automation for Manual Operations | INVARITECH",
            },
        ],
    },
    twitter: {
