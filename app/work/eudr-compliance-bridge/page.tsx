            ...
            <div className="mx-auto max-w-4xl px-6">
                ...
                <div className="mb-16">
                    ...
                    <p className="text-xl text-muted-foreground leading-relaxed">
                        As the EU Deforestation Regulation (EUDR) moves towards full enforcement, a French operator saw a challenge coming. They needed to submit thousands of Due Diligence Statements to the European Commission. Doing this manually was impossible at their scale. We built them a bridge to automate it all.
                    </p>
                </div>
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                        <Card className="bg-muted/30 border-none shadow-sm">
                            <CardContent className="pt-6">
                                <h3 className="font-semibold text-lg mb-3">Not Built for Scale</h3>
                        ...
                        <Card className="bg-muted/30 border-none shadow-sm">
                            <CardContent className="pt-6">
                                <h3 className="font-semibold text-lg mb-3">Too Complex</h3>
                                <p className="text-muted-foreground">
                ...
                <section className="mb-24">
                    ...
                    <div className="space-y-16">
                        <div className="grid gap-8 md:grid-cols-2 items-center">
                            <div>
                                ...
                                <ul className="space-y-2">
                                    ...
                                    <li className="flex items-start">
                                        <CheckCircle2 className="mr-2 size-5 text-primary shrink-0 mt-0.5" />
                                        <span>Checks for errors before sending</span>
                                    </li>
                                    <li className="flex items-start">
                                        <CheckCircle2 className="mr-2 size-5 text-primary shrink-0 mt-0.5" />
                                        <span>Easy to integrate with existing tools</span>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="grid gap-8 md:grid-cols-2 items-center">
                            <div>
                                <h3 className="text-2xl font-bold mb-4">Smart Retry System</h3>
                                <p className="text-muted-foreground mb-4">
                ...
                <section className="mb-24">
                    ...
                    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                        <div>
                            <div className="text-4xl font-bold text-primary mb-2">Scale</div>
                            <p className="text-muted-foreground">From manual entry to thousands of automated submissions per month.</p>
                        </div>
                        <div>
                            <div className="text-4xl font-bold text-primary mb-2">Speed</div>
                            <p className="text-muted-foreground">Submissions happen in seconds, running in the background.</p>
                        </div>
                        <div>
                            <div className="text-4xl font-bold text-primary mb-2">Reliability</div>
                            <p className="text-muted-foreground">Automatic retries mean nothing gets lost.</p>
                        </div>
                        <div>
                            <div className="text-4xl font-bold text-primary mb-2">Confidence</div>
                            <p className="text-muted-foreground">Fully certified for production use by the EU.</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="border-t pt-16">
                    <div className="max-w-2xl">
                        <h2 className="text-3xl font-bold mb-6">Need help with EUDR?</h2>
