...
const services = [
    {
        ...
        description: "AI PoC execution with time-to-value as the product.",
    ...
    },
    {
        ...
        cta: "View GenAI Backend Development",
        icon: Code,
    },
    {
