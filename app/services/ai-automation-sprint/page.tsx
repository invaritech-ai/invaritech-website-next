...
export const metadata: Metadata = {
    title: "AI Automation Sprint | INVARITECH",
    description: "AI PoC execution with time-to-value as the product. Get a working pilot or deployment-ready automation tied to a measurable baseline in 30 days.",
    alternates: {
            ...
            <section className="pt-40 pb-20 px-6 relative z-10">
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl font-light border-l-2 border-primary/50 pl-6 mb-12">
                        AI PoC execution with time-to-value as the product. We deliver a working pilot or deployment-ready automation tied to a measurable baseline.
                    </p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-lg leading-relaxed">
                                    A working pilot or deployment-ready automation tied to a measurable baseline. No shelf-ware.
                                </p>
                            </div>
                        </div>
                    </div>
             ...
             <section className="py-24 px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
                        Identify your ROI wedge and get started with a 30-day sprint.
                    </p>
