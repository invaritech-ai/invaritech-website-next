...
export default function SprintClient() {
    return (
        <ScrollReveal className="min-h-screen bg-background relative overflow-hidden">
            ...
            {/* The "Week 2" Reality */}
            <section className="reveal-section py-24 px-6 relative z-10 bg-black/20 border-y border-border backdrop-blur-sm">
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-start">
                        ...
                        <div className="md:w-2/3 stagger-list space-y-6">
                            {[
                                ...
                                <div key={i} className="stagger-item flex items-start gap-4 p-4 rounded-xl bg-secondary/50 border border-border/50">
                            ...
                            <p className="stagger-item text-sm text-red-400/80 font-mono pt-4 border-t border-border">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-16">
                        <div>
                            ...
                            <div className="mt-12 p-6 border border-border rounded-xl bg-secondary/50">
                                <p className="text-white/80 italic">
                                    &ldquo;If engagement cannot begin within 2 weeks, this is not a fit.&rdquo;
                                </p>
                            </div>
                            <div className="mt-6 p-6 border border-border rounded-xl bg-black/40">
                        ...
                        <div>
                            ...
                            <div className="grid gap-4 stagger-list">
                                {[
                                    ...
                                    <div key={i} className="stagger-item p-6 rounded-xl border border-border hover:border-primary/30 transition-colors bg-black/40">
            ...
            {/* Deliverables */}
            <section className="reveal-section py-24 px-6 relative z-10 bg-secondary/50">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 stagger-list">
                        {[
                            ...
                            <div key={i} className="stagger-item bg-black/40 border border-border p-8 rounded-2xl hover:bg-secondary/50 transition-colors group">
                    ...
                    <div className="grid md:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="stagger-list space-y-4">
                            {[
                                ...
                                <div key={item} className="stagger-item flex items-start gap-3 p-4 rounded-xl bg-secondary/50 border border-border/50">
                                    <div className="bg-primary/10 p-2 rounded-lg text-primary">
                            ...
                            <p className="stagger-item text-xs text-white/50 font-mono pt-4 border-t border-border">
            ...
            {/* Stack Compatibility */}
            <section className="reveal-section py-24 px-6 relative z-10 border-y border-border bg-black/20">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 mb-12">
                        {["AWS", "Azure", "GCP", "Postgres", "SQL", "ERP", "CRM", "Helpdesk", "Internal APIs", "Webhooks"].map(tech => (
                            <span key={tech} className="px-4 py-2 rounded-full border border-border bg-secondary/50 text-sm text-white/80">
                                {tech}
                            </span>
                        ))}
                    </div>
                            ...
                            {[
                                ...
                                <div key={i} className={`relative flex flex-col md:flex-row gap-8 md:gap-0 items-start md:items-center ${i % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                                    <div className={`pl-12 md:pl-0 md:w-1/2 ${i % 2 === 0 ? 'md:pl-24 text-left' : 'md:pr-24 md:text-right'}`}>
                                        ...
                                        <p className="text-sm font-mono text-white/60 border-t border-border pt-4 inline-block">
            ...
            <section className="reveal-section py-24 px-6 relative z-10 bg-secondary/50">
                <div className="max-w-5xl mx-auto">
                     ...
                     <div className="grid md:grid-cols-3 gap-6">
                        <div className="p-8 rounded-2xl border border-border opacity-60 hover:opacity-100 transition-opacity">
                            <h3 className="text-lg font-bold text-foreground mb-4">Internal R&amp;D</h3>
                        ...
                        <div className="p-8 rounded-2xl border border-border opacity-60 hover:opacity-100 transition-opacity">
                            <h3 className="text-lg font-bold text-foreground mb-4">Big Consulting</h3>
                            <ul className="space-y-4 text-sm text-muted-foreground">
                        ...
                        <div className="p-8 rounded-2xl border border-primary/50 bg-primary/5 transform md:-translate-y-4 shadow-2xl shadow-primary/10 relative">
                            ...
                            <h3 className="text-xl font-bold text-foreground mb-4">The Sprint</h3>
