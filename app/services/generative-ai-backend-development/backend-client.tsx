...
import { ArrowLeft, Check, ArrowRight, Terminal, GitBranch, ShieldCheck, Cpu, BrainCircuit, Database, Lock, Activity, DollarSign, Server, LayoutDashboard, Code, StopCircle, LineChart, Users, Zap } from "lucide-react";
    ...
    return (
        <main ref={containerRef} className="min-h-screen bg-background relative overflow-hidden">
                            ...
                            <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                        <Check className="w-4 h-4 text-primary" /> Microservice-first
                                    </div>
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                        <Check className="w-4 h-4 text-primary" /> Stack-agnostic
                                    </div>
                                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                        <Check className="w-4 h-4 text-primary" /> AI-native
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-16">
                        ...
                        <div>
                            <ul className="space-y-4 stagger-list">
                                {[
                                    { text: "Teams that already shipped a GenAI feature", icon: Users },
                                    { text: "Founders watching token bills climb", icon: DollarSign },
                                    { text: "CTOs tired of prompt tweaking in production", icon: Terminal },
                                    { text: "Companies afraid scaling users will destroy margins", icon: LineChart }
                                ].map((item, i) => (
                                    <li key={i} className="stagger-item flex gap-4 p-4 border border-white/5 rounded-lg bg-white/5">
            ...
            <section className="reveal-section py-24 px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 stagger-list text-left">
                        ...
                        <div className="stagger-item p-6 border border-white/10 rounded-xl bg-black/40">
                            <h3 className="font-bold text-white mb-2">Cost Control</h3>
                            <p className="text-sm text-muted-foreground">Architected to keep margins healthy as you scale user count.</p>
                        </div>
                        <div className="stagger-item p-6 border border-white/10 rounded-xl bg-black/40">
                            <h3 className="font-bold text-white mb-2">Change Management</h3>
                            <p className="text-sm text-muted-foreground">Pass security reviews without slowing delivery to zero.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="reveal-section py-24 px-6 relative z-10 bg-white/5">
                <div className="max-w-5xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <Badge variant="outline" className="mb-4 border-primary/50 text-priority px-3 py-1 text-xs uppercase tracking-widest text-primary">
                                The Standard
                            </Badge>
                            <h2 className="text-3xl md:text-4xl font-bold mb-6">Prompts as Code</h2>
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        <strong className="text-white block">Version Control</strong>
                                        <span className="text-muted-foreground text-sm">Prompts and configs are versioned in Git like core infrastructure.</span>
                                    </div>
                                </li>
                                <li className="flex gap-3">
                                ...
                                <li className="flex gap-3">
                                    ...
                                    <div>
                                        <strong className="text-white block">Release Discipline</strong>
                                        <span className="text-muted-foreground text-sm">Prompt/model changes ship behind flags, with rollback paths.</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="bg-black/50 border border-white/10 rounded-xl p-6 font-mono text-sm text-muted-foreground overflow-hidden">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="pl-4">✓ cost_per_token: $0.0002 <span className="text-green-500">(-15%)</span></p>
                                <p><span className="text-green-400">Deployment approved.</span> Rolling out to 5% canary.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="reveal-section py-24 px-6 relative z-10">
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-bold mb-6">The Right-Tool Architecture</h2>
                    ...
                    <div className="overflow-hidden border border-white/10 rounded-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 bg-black/20 border-b border-white/10 group hover:bg-white/5 transition-colors">
                            <div className="p-6 border-b md:border-b-0 border-white/5 text-white font-bold">Predictive Intelligence</div>
                            <div className="p-6 border-b md:border-b-0 border-white/5 text-primary font-mono flex items-center gap-2">
                                <BrainCircuit className="w-4 h-4" /> Traditional ML
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 bg-black/20 border-b border-white/10 group hover:bg-white/5 transition-colors">
                            <div className="p-6 border-b md:border-b-0 border-white/5 text-white font-bold">Bridge Logic</div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 bg-black/20 group hover:bg-white/5 transition-colors">
                            <div className="p-6 border-b md:border-b-0 border-white/5 text-white font-bold">Business Logic</div>
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex flex-col md:flex-row gap-16 items-center">
                        <div className="md:w-1/2">
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold mb-6">The Anti-Havoc Backend</h2>
                        ...
                        <div className="md:w-1/2 w-full space-y-4 stagger-list">
                                ...
                                <div>
                                    <h4 className="font-bold text-white mb-1">No Silent Writes</h4>
                                    <p className="text-sm text-muted-foreground">AI does not alter databases or execute decisions without checks.</p>
                                </div>
                                </div>
                                <div className="stagger-item p-6 border border-white/10 rounded-xl bg-black/40 flex gap-4">
                                <ShieldCheck className="w-6 h-6 text-primary shrink-0" />
                                <div>
                                    <h4 className="font-bold text-white mb-1">Least Privilege</h4>
                                    <p className="text-sm text-muted-foreground">Tool access is scoped to the workflow, not “whatever the model wants.”</p>
                                </div>
                                </div>
                                <div className="stagger-item p-6 border border-white/10 rounded-xl bg-black/40 flex gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Every model call, tool call, and state transition is logged.</p>
                                </div>
                                </div>
                        </div>
                    </div>
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="bg-white/5 border border-white/10 rounded-3xl p-8 md:p-12">
                         <div className="text-center mb-12">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">Telemetry That Protects Margins</h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                { title: "Usage Attribution", desc: "Cost per task, customer, or workflow." },
                                { title: "Telemetry ROI", desc: "Tie spend to hours reclaimed and SLA lift." },
                                { title: "Chat Recreation", desc: "Replay real interactions to fix failure modes." },
                                { title: "Model Routing", desc: "Optimize model selection to control spend." }
                            ].map((item, i) => (
                                <div key={i} className="p-4 border border-white/10 rounded-lg bg-black/20 text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 stagger-list">
                         <div className="stagger-item">
                            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
                                <Server className="w-5 h-5 text-primary" /> Microservices & APIs
                            </h3>
                            <p className="text-muted-foreground">For AI-native features like RAG, extraction, drafting, and triage.</p>
                         </div>
                         <div className="stagger-item">
                            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
                                <Check className="w-5 h-5 text-primary" /> Eval Harnesses
                            </h3>
                            <p className="text-muted-foreground">Golden datasets and regression gates to ensure massive reliability.</p>
                         </div>
                         <div className="stagger-item">
                            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
                                <LineChart className="w-5 h-5 text-primary" /> Observability Stack
                            </h3>
                            <p className="text-muted-foreground">Logs, traces, cost monitoring, and dashboards.</p>
                         </div>
                         <div className="stagger-item">
                            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3">
                                <ShieldCheck className="w-5 h-5 text-primary" /> Guardrails
                            </h3>
                            <p className="text-muted-foreground">Policy boundaries, approvals, fallbacks, and safe rollout patterns (feature flags).</p>
                         </div>
                    </div>
                 </div>
            </section>
            ...
            <section className="reveal-section py-24 px-6 relative z-10 bg-white/5">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <div className="inline-block border border-white/20 rounded-xl p-8 bg-black/40">
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-sm text-white/70">
                            <span className="px-3 py-1 border border-white/10 rounded-full">Idempotency</span>
                            <span className="px-3 py-1 border border-white/10 rounded-full">Regression Control</span>
                            <span className="px-3 py-1 border border-white/10 rounded-full">Token Discipline</span>
                            <span className="px-3 py-1 border border-white/10 rounded-full">Safe Change Management</span>
                        </div>
                    </div>
                </div>
            </section>
             ...
             <section className="reveal-section py-24 px-6 relative z-10">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-3xl font-bold mb-12 text-center">Production Health Metrics</h2>
                    <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                        {[
                            { label: "Human Hours Reclaimed", val: "Countable" },
                            { label: "Verified Decision Rate", val: "% Safe Actions" },
                            { label: "Prompt Regression", val: "Zero" },
                            { label: "ROI Visibility", val: "100%" },
                            { label: "Margin Delta", val: "Protect" }
                        ].map((m, i) => (
                            <div key={i} className="p-6 border border-white/10 rounded-xl bg-white/5 text-center hover:border-primary/50 transition-colors">
                                <div className="text-2xl font-bold text-white mb-2">{m.val}</div>
