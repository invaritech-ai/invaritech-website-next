...
export const post: BlogPost = {
    slug: "why-manual-eudr-compliance-fails-at-scale",
    ...
    content: `
# Why Manual EUDR Compliance Fails at Scale: A Case Study
...
[Automation](/blog/regulatory-automation-why-it-matters) is a practical path. A well-designed system gives consultants a tool they can use for their clients. It improves accuracy and lowers the time needed for daily work.
...
If you want to prepare for automated EUDR compliance, you can read [our technical guide](/blog/eudr-automation-technical-solution).
...
If you have questions about your EUDR setup, you can [contact](/contact) us or book a [call](https://calendly.com/hello-invaritech/30min).
    ...
    coverImage: "/blog/eudr-compliance-fails-case-study.webp",
};
