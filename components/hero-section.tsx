                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        >
                            <div className="mask-b-from-55% relative mr-0 mt-8 overflow-hidden px-1 sm:px-2 sm:mt-12 md:mt-20">
                                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-2 sm:p-4 shadow-lg ring-1">
                                    <Image
