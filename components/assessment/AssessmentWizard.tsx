...
const functionFocusOptions = [
    ...
    { value: "customer-support", label: "SUPPORT / CX" },
...
export function AssessmentWizard() {
    ...
    const resetWizard = () => {
        ...
        setResult(null);
        setInputs({
            companySize: "", functionFocus: "", primaryWorkflowGoal: "",
            monthlyVolumeBand: "", currentAHTBand: "", errorTolerance: "",
            processMaturity: "", dataStructure: "", dataAccessReadiness: "",
            tooling: [], sponsorReady: "", budgetFit: "",
        });
            ...
            <div className="relative z-10 container mx-auto px-6 md:px-12">
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {step === 6 && <CalculatingState />}
                        {step === 7 && result && <AssessmentResults result={result} inputs={inputs} onReset={resetWizard} />}
                    </motion.div>
                </AnimatePresence>
            </div>
