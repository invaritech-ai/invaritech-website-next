            ...
            <div className="mx-auto max-w-7xl px-6 relative z-10">
                <div className="mb-16 max-w-3xl">
                    <div className="ep-header flex items-center gap-3 mb-6">
                        <span className="text-[11px] font-mono text-foreground-subtle">05</span>
                    ...
                    <h2 className="ep-header font-editorial text-5xl font-semibold leading-[0.9] md:text-7xl tracking-tight text-foreground">
                        The Sprint Is<br />
                        <span className="text-foreground-muted">Just the Entry Point.</span>
                    </h2>
                    <p className="ep-header mt-8 text-foreground-muted text-lg leading-relaxed">
                ...
                <div className="ep-grid grid gap-5 md:grid-cols-2 lg:grid-cols-3">
                    {paths.map((path) => (
                        <div
                            key={path.title}
                            className="ep-card group relative p-8 border border-border bg-card hover:border-primary/20 transition-all duration-300"
                        >
                            ...
                            <p className="text-foreground-muted text-sm leading-relaxed mb-6 min-h-[60px]">
                                {path.description}
                            </p>

                            <Link
                                href={path.href}
                                className="inline-flex min-h-10 items-center gap-2 text-[11px] font-mono uppercase tracking-[0.15em] text-foreground-muted hover:text-foreground transition-colors group/link"
                            >
